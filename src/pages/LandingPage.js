                            ...
                            <div className="row justify-content-center">
                                <div className="col-lg-12">
                                    <div className="hero-content">
                                        <h1 className="text-dark mb-3">Hello! I'm Ming Yang,</h1>
                                        <h4 className="text-dark text-capitalize mb-0"><span className="base-color">A  </span> <span className="element" data-elements="Frontend Developer.,Web Developer.,Photographer.,Diver."></span></h4>
